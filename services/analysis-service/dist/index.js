...
export class AnalysisService {
    constructor(sessionId, domainTracker, memoryService) {
     ...
     */
    async detectPatterns(domainState) {
        const patterns = [];
        // Work patterns
        if (domainState.work) {
     ...
     * Detect anomalies
     */
    async detectAnomalies(domainState, patterns) {
        const anomalies = [];
     ...
     */
    async detectOpportunities(domainState, patterns) {
        const opportunities = [];
     ...
     */
    async generateInterventions(patterns, anomalies, opportunities) {
        const interventions = [];
     ...
     * Generate summary
     */
    generateSummary(lifeBalance, patterns, anomalies, opportunities) {
        const lines = [];
     ...
     */
    extractKeyInsights(patterns, anomalies, opportunities, lifeBalance) {
        const insights = [];
        // Balance insights
        const outOfBalance = [
