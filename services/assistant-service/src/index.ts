...
export class AssistantService {
  ...
  createWorker(queue: TaskQueue, policyService: PolicyService, config?: WorkerConfig): AssistantWorker {
    this.worker = new AssistantWorker(this.descriptor, queue, policyService, config);
    return this.worker;
  }
