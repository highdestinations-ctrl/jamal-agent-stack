...
export class AssistantService {
  ...
  createWorker(queue: TaskQueue, policyService: PolicyService, skillService: SkillService, config?: WorkerConfig): AssistantWorker {
    this.worker = new AssistantWorker(this.descriptor, queue, policyService, skillService, config);
    return this.worker;
  }
